...
public class GraphConfigJava9Parser extends Parser {
	...
	public static class HandlerContext extends ParserRuleContext {
		...
		public TerminalNode SYNC_HANDLER() { return getToken(GraphConfigJava9Parser.SYNC_HANDLER, 0); }
	...
	public final HandlerContext handler() throws RecognitionException {
		...
		try {
			...
			setState(686);
			_la = _input.LA(1);
			if ( !(_la==HANDLER || _la==SYNC_HANDLER) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AnyGraphKeywordContext anyGraphKeyword() throws RecognitionException {
		...
		try {
			...
			setState(885);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << SUBGRAPH) | (1L << MERGER) | (1L << HANDLER) | (1L << SYNC_HANDLER) | (1L << PAYLOAD) | (1L << COMPLETE) | (1L << ROUTER) | (1L << CLONE))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
