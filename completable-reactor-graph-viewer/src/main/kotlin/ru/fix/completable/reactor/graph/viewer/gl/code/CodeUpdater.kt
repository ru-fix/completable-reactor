...
class CodeUpdater {
    ...
    fun coordinateCodePhraseFromModel(graphModel: GraphModel): List<CoordinateCodePhrase> {
     ...
     */
    fun updateCoordinates(codeBlock: String, coordinates: List<CoordinateCodePhrase>): String {
    ...
    fun updateCoordinates(codeBlock: String, graphModel: GraphModel) {
        updateCoordinates(codeBlock, coordinateCodePhraseFromModel(graphModel))
    }

    fun generateCoordinateBuilderCode(phrase: CoordinateCodePhrase): String {
        return when (phrase) {
