...
[source,java]
----
include::../completable-reactor-example/src/main/java/ru/fix/completable/reactor/example/flight/ticket/BuyFlightTicketPayload.java[tags=payload]
----
...
include::completable-reactor-runtime/completable-reactor-runtime.adoc[]
...
include::best-practice-code-convention/best-practice-code-convention.adoc[]
