...
import ru.fix.completable.reactor.runtime.gl.ExecutionBuilder.Companion.INVALID_TRANSITION_PAYLOAD_CONTEXT
...
class HandleByExecutionBuilder<PayloadType>(
    ...
    private fun invokeHandlingMethod(
        ...
        // Subgraph
            pvx.vertex.subgraph != null -> invokeSubgraphHandlingMethod(pvx, payload)
