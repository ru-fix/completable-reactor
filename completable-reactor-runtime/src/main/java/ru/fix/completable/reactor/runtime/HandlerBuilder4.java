 ...
 */
public class HandlerBuilder4<ContextResult, PayloadType, ProcessorType , Arg1, Arg2, Arg3, Arg4> extends BaseDescriberItem<ContextResult> {
    ...
    public <Arg5> HandlerBuilder5<ContextResult, PayloadType, ProcessorType, Arg1, Arg2, Arg3, Arg4, Arg5> passArg(Function<PayloadType, Arg5> arg) {
        processorDescription.arg5 = arg;
        return new HandlerBuilder5<>(contextResult, processorDescription);
    }

    public <Arg5> HandlerBuilder5<ContextResult, PayloadType, ProcessorType, Arg1, Arg2, Arg3, Arg4, Arg5> copyArg(Function<PayloadType, Arg5> arg) {
        processorDescription.arg5 = arg;
